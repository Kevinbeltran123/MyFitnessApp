...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    _nutritionService = NutritionService(_apiClient);
  ...
  Future<_HomeSummary> _loadSummary() async {
    ...
    try {
      final results = await Future.wait<dynamic>(<Future<dynamic>>[
        _nutritionService.fetchDailyNutrition(date: today),
        _workoutService.fetchExercises(limit: 6),
      ]);

      final nutrition = results[0] as List<NutritionEntry>;
      final workoutsResponse = results[1] as WorkoutPlansResponse;
      ...
      debugPrint('Error loading home summary: $error\n$stackTrace');
      rethrow;
    }
  }
